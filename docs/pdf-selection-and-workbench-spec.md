...
状态：P0、P1-A、P1-B、P2-A、P2-B、P2-C 已完成（2026-07-16）。下一阶段是 P3-A 低置信度外部解析回退与公式/表格区域模式。
...
| P3-A（下一步） | 低置信度外部解析适配器、公式/表格区域模式 | 复杂页显式回退或区域降级，不伪造精确文本 |
| P3-B | 真实评测集、指标面板与多论文对比完善 | 选择/证据/门禁/对比指标可重复运行并查看 |
