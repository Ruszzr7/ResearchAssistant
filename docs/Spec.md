...
Research Assistant 是本地运行的科研助手，目标是把论文管理、文献检索、PDF 阅读、论文理解、Agent 连续对话和研究档案连接成可恢复、可追溯的系统。
...
- 旧的独立论文对比、Gap 分析、自然语言计划、导出同步、引用网络扩展和写作助手已退出当前产品范围；论文研究页保留“添加对比文献”入口，后续在论文研究能力内实现。
