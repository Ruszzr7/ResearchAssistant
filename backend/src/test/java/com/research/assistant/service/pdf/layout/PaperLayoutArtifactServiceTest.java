...
class PaperLayoutArtifactServiceTest {
    ...
    void shouldReturnMatchingCachedArtifactWithoutParsingPdfAgain() throws Exception {
        ...
        when(artifactMapper.selectReady(5L, hash, "pdfbox-layout-v1+semantic-v5+inline-math-v1"))
                .thenReturn(cached);
    ...
    void shouldParseEnrichAndPersistWhenCacheDoesNotMatch() throws Exception {
        ...
        when(artifactMapper.selectReady(7L, hash, "pdfbox-layout-v1+semantic-v5+inline-math-v1"))
        ...
        assertThat(artifact.parserVersion()).isEqualTo("pdfbox-layout-v1+semantic-v5+inline-math-v1");
        ...
        assertThat(captor.getValue().getParserVersion())
                .isEqualTo("pdfbox-layout-v1+semantic-v5+inline-math-v1");
    ...
    private PaperLayoutArtifactRecord record(Long id,
        ...
        record.setParserVersion("pdfbox-layout-v1+semantic-v5+inline-math-v1");
