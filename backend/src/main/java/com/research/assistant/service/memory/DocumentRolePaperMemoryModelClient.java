...
@Component
public class DocumentRolePaperMemoryModelClient implements PaperMemoryModelClient {
    private final LangChain4jModelFactory modelFactory;
    private final AiCapabilityService capabilityService;

    public DocumentRolePaperMemoryModelClient(LangChain4jModelFactory modelFactory,
